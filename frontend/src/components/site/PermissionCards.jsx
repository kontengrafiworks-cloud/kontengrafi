...
const CARDS = [
    {
        ...
        body: "Moodboard, tone, dan referensi visual brand Anda kami simpan. Order konten berikutnya cukup satu kalimat — kami sudah tahu gaya yang harus diproduksi.",
    },
    {
        id: "shoot",
        ...
        body: "Kamera, lighting, stylist, dan property — kami bawa lengkap. Satu hari shoot menghasilkan stok konten dua minggu, UGC maupun commercial.",
    },
    {
        id: "delivery",
